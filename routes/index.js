...
const {hasOrganiserOrAdminAuth,redirectToDashboard,isLoggedIn, hasAdminAuth, 
    hasParentAuth, hasOrganiserAuth, hasDefaultPasswordAuth/*, hasBasketAuth*/,organiserCreatedCard} = require('../middleware/hasAuth');


    // router.get('/addCountry', dadController.addCountry);
    ...
    router.get('/addSchool', isLoggedIn, hasAdminAuth, function(req, res, next) {
        res.render('addSchool', {user:req.user});
    });

    router.get('/getDelivery',isLoggedIn, dadController.getDelivery);
    router.get('/addPackage', isLoggedIn, hasAdminAuth, function(req,res){
    ...
    // router.get('/parentDashboard',isLoggedIn,hasParentAuth, dashboardController.parentDashboard);
    router.get('/getBasketItems',isLoggedIn,hasDefaultPasswordAuth, dashboardController.getBasketItems);
    // router.post('/updateBasketItemQuantity',isLoggedIn, hasDefaultPasswordAuth, hasParentAuth,hasDefaultPasswordAuth,dashboardController.updateBasketItemQuantity);
    ...
    router.get('/continue', schoolController.continue);
    ...
    router.post('/captcha', signUpController.captcha);
