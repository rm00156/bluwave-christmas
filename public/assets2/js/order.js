...
function proceedEdit(e) {
  ...
  $.ajax({
    ...
    data: {
      basketItemId: editBasketItemId,
      productItemNumber: editProductItemNumber,
    },
...
function editModal(e) {
  editProductItemNumber = e.currentTarget.getAttribute(
...
function navigateToProductItem(e) {
  var productItemNumber = e.currentTarget.getAttribute(
    "data-productItemNumber"
  );
...
function setShipped(e) {
  ...
  $.ajax({
    ...
    success: function () {
      window.location =
        "/new_order_details?orderNumber=" + "blu-" + purchaseBasketId;
    },
  });
}
