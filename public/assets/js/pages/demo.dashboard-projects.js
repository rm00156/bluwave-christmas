            ...
            return (
                0 < o("#task-area-chart").length &&
                    ...
                    e.push(
                        this.respChart(o("#task-area-chart"), "Bar", t, {
                            ...
                            plugins: { filler: { propagate: !1 }, legend: { display: !1 }, tooltips: { intersect: !1 }, hover: { intersect: !0 } },
                            scales: { x: { grid: { color: "rgba(0,0,0,0.05)" } }, y: { ticks: { stepSize: 10, display: !1 }, min: 10, max: 100, display: !0, borderDash: [5, 5], grid: { color: "rgba(0,0,0,0)", fontColor: "#fff" } } },
                        })
                    )),
                0 < o("#project-status-chart").length &&
                    ((a = {
                        ...
                        datasets: [{ data: [$('#numberOfCompleted').val(), $('#numberOfNonCompleted').val()], backgroundColor: (r = o("#project-status-chart").data("colors")) ? r.split(",") : ["#0acf97", "#727cf5", "#fa5c7c"], borderColor: "transparent", borderWidth: "3" }],
                    }),
                    e.push(this.respChart(o("#project-status-chart"), "Doughnut", a, { maintainAspectRatio: !1, cutout: 80, plugins: { cutoutPercentage: 40, legend: { display: !1 } } }))),
                e
            );
        }),
