    ...
    return models.account.findOne({
      ...
      if (req.body.school != undefined) {
        await models.sequelize.query(
          ...
          .then((school) => {
            if (school.length > 0) {
              if (school[0].postCode == req.body.postCode) errors.postCode = 'A school with this post code already exists. Please log in';

              if (school[0].email == req.body.email) errors.email = 'A school with this email already exists. Please log in';
            }
          });
      }
  ...
  return new Promise((resolve, reject) => {
    ...
    models.account.findOne({
      ...
      models.school.findOne({
        ...
        if (school != null) errors.school = 'A school already exists with this name and post code';
        ...
        models.school.findOne({
          ...
          if (school != null) errors.school = 'A school already exists with this email ';
